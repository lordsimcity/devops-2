...
<html lang="fr"><head><meta charset="utf-8"><title>IC GROUP - Portail</title>
...
<body><header><h1>IC GROUP</h1><p>Portail d'accès aux applications internes</p></header>
...
@app.get("/health")
def health():
    return {"application": "icgroup-portal", "status": "ok"}, 200
